...
class FourierTransformation:
    """
    A class for performing Fourier transformations and abstracting frequency features from data.

    Methods:
        find_fft_transformation(data, sampling_rate):
            Find the amplitudes of the different frequencies using a fast Fourier transformation.

        abstract_frequency(data_table, cols, window_size, sampling_rate):
            Abstract frequency features from a data table using Fourier transformations.

    Args:
        data: The data to perform the Fourier transformation on.
        sampling_rate: The sampling rate of the data.

    Returns:
        The real and imaginary parts of the Fourier transformation.
    ...
    def abstract_frequency(self, data_table, cols, window_size, sampling_rate):
        ...
        Args:
            data_table: The data table to abstract frequency features from.
            cols: The columns in the data table to abstract.
            window_size: The size of the window for computing frequency features.
            sampling_rate: The sampling rate of the data.

        Returns:
            The data table with the abstracted frequency features added.
